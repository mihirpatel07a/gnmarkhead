<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="gnmarkhead.Student1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="display: flex; flex-wrap: wrap; justify-content: space-between;">
            ...
            <div class="grid-container">
                ...
                <div class="content">
                    <asp:GridView ID="theory_gridview" runat="server" CssClass="gridview"></asp:GridView>
                </div>
            </div>
